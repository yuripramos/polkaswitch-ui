      ...
      <div className="custom-token-warning">
        <div className="warning-box">
            ...
            <div>
                ...
                <div className="warning-text">This token is not whitelisted by swing. The Swing team makes no representation about the quality or legal categorization of the token.</div>
            </div>
        </div>
      </div>
    );
