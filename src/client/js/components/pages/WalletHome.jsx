        ...
        <div className="column main">
          <div className="card wallets-page-card">
                    ...
                    <div className="dropdown-content">
                      ...
                      <a href="#" className="dropdown-item">
                        <img
                          ...
                          alt=""
                          className="is-rounted asset-icon"
                        />
            ...
            <div className="columns is-hidden-mobile">
              <div className="column">
                <div className="portfolio-makeup__heading">
                  Portfolio Makeup
                </div>
              </div>
            </div>
            ...
            <div className="columns is-hidden-mobile portfolio-makeup">
              <div className="column is-3">
                <img
                  className="is-rounded asset-icon"
                  src="https://bulma.io/images/placeholders/128x128.png"
                />
                <div className="portfolio-makeup__asset_container">
                  <span className="portfolio-makeup__asset_heading">
                    Ethereum
                  </span>
        ...
        <div className="column main">
          <div className="card wallets-page-card">
            <div className="heading-container">
              ...
              <span className="heading-container__sub">
                  ...
                  <div className="column is-3 is-6-mobile">
                    ...
                    <div className="asset-table__content">
                      ...
                      <span className="asset-table__sub">
                        LINK
                        <span className="asset-table__sub__chain">BSC</span>
                      </span>
                    </div>
                  </div>
                ...
                <div className="columns asset-table__row">
                  <div className="column is-3">
                    ...
                    <div className="asset-table__content">
                      ...
                      <span className="asset-table__sub">ETH</span>
                    </div>
                  </div>
                  <div className="column is-hidden-mobile is-3 align-right">
