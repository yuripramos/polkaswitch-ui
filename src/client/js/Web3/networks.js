module.exports = {
    ...
    43114: {
        ...
        crossChainSupported: true,
        supportedCrossChainTokens: ["USDT", "DAI"],
    },
    3: {
        enabled: true,
        name: "Ropsten",
        ...
        chain: {
            chainId: "0x03",
            rpcUrls: ["https://ropsten.infura.io/v3/8aa64403febb43359abf4c05b735dbbc"],
            chainName: "Ropsten",
            nativeCurrency: {
                name: "ETH",
                symbol: "ETH",
        ...
        tradeView: {
            platform: "Ropsten",
            lineUrl: "https://api.coingecko.com/api/v3/coins/ropsten",
            candleStickUrl: "https://api.coingecko.com/api/v3/coins",
        },
        crossChainSupported: true,
        supportedCrossChainTokens: [],
    ...
    4: {
        ...
        chain: {
            chainId: "0x04",
            rpcUrls: ["https://rinkeby.infura.io/v3/8aa64403febb43359abf4c05b735dbbc"],
            chainName: "Ropsten",
            nativeCurrency: {
                name: "ETH",
                symbol: "ETH",
        ...
        tradeView: {
            platform: "Rinkeby",
            lineUrl: "https://api.coingecko.com/api/v3/coins/rinkeby",
            candleStickUrl: "https://api.coingecko.com/api/v3/coins",
        },
        crossChainSupported: true,
        supportedCrossChainTokens: [],
